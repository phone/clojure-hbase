(defproject clojure-hbase "0.94.6"
  ...
  :dependencies [[org.clojure/clojure "1.5.1"]
                 ...
                 [org.apache.hbase/hbase "0.94.6" :classifier "tests" :scope "test"]
                 ;; [org.apache.hbase/hbase "0.94.2-cdh4.2.1" :classifier "tests" :scope "test"]
  ...
  :profiles {:clojure1.2 {:dependencies [[org.clojure/clojure "1.2.0"]]}
             ...
             :hbase92 {:dependencies [[org.apache.hbase/hbase "0.92.2-cdh4.2.0"]
                                      [org.apache.hbase/hbase "0.92.2-cdh4.2.0"
                                       :classifier "tests"
                                       :scope "test"]
                                      [org.apache.hadoop/hadoop-test "1.1.0" :scope "test"]]}
             :hbase94 {:dependencies [[org.apache.hbase/hbase "0.94.2-cdh4.2.0"]
                                      [org.apache.hbase/hbase "0.94.2-cdh4.2.0"
                                       :classifier "tests"
                                       :scope "test"]
                                      [org.apache.hadoop/hadoop-test "1.1.0" :scope "test"]]}
             :cdh4 {:dependencies [[org.apache.hbase/hbase "0.92.1-cdh4.2.0"]
                                   [org.apache.hadoop/hadoop-common "2.0.0-cdh4.1.2" :scope "test"]
                                   [org.apache.hadoop/hadoop-hdfs "2.0.0-cdh4.1.2" :scope "test"]
                                   [org.apache.hbase/hbase "0.92.1-cdh4.2.0"
                                    :classifier "tests"
                                    :scope "test"]
                                   ...
                                   [org.apache.hadoop/hadoop-hdfs "2.0.0-cdh4.1.2"
                                    :classifier "tests"
                                    :scope "test"]
                                   [org.apache.hadoop/hadoop-test "2.0.0-mr1-cdh4.1.2"
                                    :scope "test"]]
